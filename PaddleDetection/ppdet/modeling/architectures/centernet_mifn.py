...
__all__ = ['CenterNet_mifn']


@register
class CenterNet_mifn(BaseArch):
    """
    ...
    def __init__(self,
                 ...
                 for_mot=False):
        super(CenterNet_mifn, self).__init__()
    ...
    def _forward(self):
        neck_feat, dif, flow, depth, density = self.backbone(self.inputs)
        if self.neck is not None:
            neck_feat = self.neck(neck_feat, dif, flow, depth, density)
